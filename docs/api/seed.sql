...
INSERT INTO sms_templates (id, key_name, name, body, enabled, updated_at) VALUES
  ...
  ('01J8TMPL0000000000000PREB', 'pre_break',
   'תזכורת לפני הפסקה',
   '{{firstName}}, לפי הנתונים שהזנת באתר, הגעת לשלושת הימים בהם אין ליטול את הטיפול טרוקאפ, יש לפעול לפי הוראות הרופא המטפל והעלון לצרכן.',
   1, CURRENT_TIMESTAMP(3)),

  ('01J8TMPL0000000000000NEWC', 'new_cycle',
   'תחילת מחזור חדש',
   '{{firstName}}, לפי הנתונים שהזנת באתר, זה היום שלך להתחיל את הטיפול בטרוקאפ, יש לפעול לפי הוראות הרופא המטפל והעלון לצרכן.',
   1, CURRENT_TIMESTAMP(3)),
...
INSERT INTO email_templates (id, key_name, name, subject, body, enabled, updated_at) VALUES
  ...
  ('01J8TMPL0000000000001PREB', 'pre_break',
   ...
   '<p>{{firstName}},</p><p>לפי הנתונים שהזנת באתר, הגעת לשלושת הימים בהם אין ליטול את הטיפול טרוקאפ, יש לפעול לפי הוראות הרופא המטפל והעלון לצרכן.</p>',
   1, CURRENT_TIMESTAMP(3)),

  ('01J8TMPL0000000000001NEWC', 'new_cycle',
   'תחילת מחזור חדש',
   'תחילת מחזור חדש — TruCare',
   '<p>{{firstName}},</p><p>לפי הנתונים שהזנת באתר, זה היום שלך להתחיל את הטיפול בטרוקאפ, יש לפעול לפי הוראות הרופא המטפל והעלון לצרכן.</p>',
   1, CURRENT_TIMESTAMP(3)),
