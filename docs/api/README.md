...
| מפתח | מתי נשלח | תוכן |
|-------|----------|-------|
| `start_treatment` | יום 1 בבוקר (>= 08:00) — רק ביום הראשון האמיתי של הטיפול | הודעת התחלת טיפול — 4 ימים רצופים |
| `pre_break` | יום 4 בבוקר (>= 08:00) | תזכורת לפני הפסקה של 3 ימים |
| `new_cycle` | יום 7 בבוקר (>= 08:00) | תזכורת לתחילת מחזור חדש של 4 ימי טיפול |
...
- יום 1 (רק היום הראשון האמיתי של הטיפול): `start_treatment`.
- ימים 4 ו-7 במחזור של 7 ימים: יום 4 → `pre_break`, יום 7 → `new_cycle`.
