...
const smsTemplates: SmsTemplate[] = [
  ...
  },
  {
    id: uid(),
    key: "pre_break",
    name: "תזכורת לפני הפסקה",
    body: "{{firstName}}, לפי הנתונים שהזנת באתר, הגעת לשלושת הימים בהם אין ליטול את הטיפול טרוקאפ, יש לפעול לפי הוראות הרופא המטפל והעלון לצרכן.",
    enabled: true,
    updatedAt: subDays(now(), 2).toISOString(),
  },
  {
    id: uid(),
    key: "new_cycle",
    name: "תחילת מחזור חדש",
    body: "{{firstName}}, לפי הנתונים שהזנת באתר, זה היום שלך להתחיל את הטיפול בטרוקאפ, יש לפעול לפי הוראות הרופא המטפל והעלון לצרכן.",
    enabled: true,
    updatedAt: subDays(now(), 2).toISOString(),
  },
  {
...
const emailTemplates: EmailTemplate[] = [
  ...
  },
  {
    ...
    key: "pre_break",
    name: "תזכורת לפני הפסקה",
    subject: "תזכורת לפני הפסקה — TruCare",
    body: "<p>{{firstName}},</p><p>לפי הנתונים שהזנת באתר, הגעת לשלושת הימים בהם אין ליטול את הטיפול טרוקאפ, יש לפעול לפי הוראות הרופא המטפל והעלון לצרכן.</p>",
    enabled: true,
    updatedAt: subDays(now(), 2).toISOString(),
  },
  {
    ...
    key: "new_cycle",
    name: "תחילת מחזור חדש",
    subject: "תחילת מחזור חדש — TruCare",
    body: "<p>{{firstName}},</p><p>לפי הנתונים שהזנת באתר, זה היום שלך להתחיל את הטיפול בטרוקאפ, יש לפעול לפי הוראות הרופא המטפל והעלון לצרכן.</p>",
    enabled: true,
    updatedAt: subDays(now(), 2).toISOString(),
  },
  {
