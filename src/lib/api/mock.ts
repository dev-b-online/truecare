...
const smsTemplates: SmsTemplate[] = [
  ...
  },
  {
    ...
    body: "{{firstName}}, מחר תקופת הפסקה של 3 ימים. מחר, מחרתיים ומחרתיים לא תצטרך לקחת תרופה.",
    enabled: true,
    updatedAt: subDays(now(), 2).toISOString(),
  },
  {
    ...
    body: "{{firstName}}, מחר מתחיל מחזור חדש של 4 ימי טיפול. אל תשכח/י לקחת את המנות בזמנן!",
    enabled: true,
    updatedAt: subDays(now(), 2).toISOString(),
  },
  {
...
const emailTemplates: EmailTemplate[] = [
  ...
  },
  {
    ...
    body: "<p>{{firstName}},</p><p>מחר מתחילה תקופת הפסקה של 3 ימים. ב-3 הימים הקרובים לא תצטרכו לקחת תרופה.</p>",
    enabled: true,
    updatedAt: subDays(now(), 2).toISOString(),
  },
  {
    ...
    body: "<p>{{firstName}},</p><p>מחר מתחיל מחזור חדש של 4 ימי טיפול. אל תשכח/י לקחת את המנות בזמנן!</p>",
    enabled: true,
    updatedAt: subDays(now(), 2).toISOString(),
  },
  {
